...
export const prettyPrintFixture = <T>(fixture: ComponentFixture<T>, theme?: Theme): void => {
  console.log(prettyFixture(fixture, theme));
};

export const prettyFixture = <T>(fixture: ComponentFixture<T>, theme?: Theme): string => {
